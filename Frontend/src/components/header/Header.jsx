  ...
  return (
    <div className='header section__padding'>
      <div className="header-content">
        <div>
          <h1>BROWSE THROUGH THE LATEST COUPONS AND GIFTS</h1>
          <img className='shake-vertical' src={coin} alt="" />
        </div>
      </div>
      <div className="header-slider">
        <h1>TOP SELLING COUPONS</h1>
       <Slider {...settings} className='slider'>
            <div className='slider-card'>
              ...
              <p className='slider-card-name'>KFC</p>
              </Link>
            ...
            <div className='slider-card'>
              ...
              <Link to={`/profile/Rian`}>
              <p className='slider-card-name'>OYO ROOMS</p>
              </Link>
            ...
            <div className='slider-card'>
              ...
              <Link to={`/profile/Rian`}>
              <p className='slider-card-name'>WOW MOMO</p>
              </Link>
            ...
            <div className='slider-card'>
              ...
              <Link to={`/profile/Rian`}>
              <p className='slider-card-name'>MYNTRA</p>
              </Link>
            ...
            <div className='slider-card'>
              ...
              <Link to={`/profile/Rian`}>
              <p className='slider-card-name'>WILDKRAFT</p>
              </Link>
            ...
            <div className='slider-card'>
              ...
              <Link to={`/profile/Rian`}>
              <p className='slider-card-name'>BoAT</p>
              </Link>
            ...
            <div className='slider-card'>
              ...
              <Link to={`/profile/Rian`}>
              <p className='slider-card-name'>PHARMEASY</p>
              </Link>
              <p className='slider-card-price'>4.932 <span>ETH</span></p>
            </div>
            <div className='slider-card'>
              ...
              <Link to={`/profile/Rian`}>
              <p className='slider-card-name'>PIZZAHUT</p>
              </Link>
              <p className='slider-card-price'>4.932 <span>ETH</span></p>
            </div>
